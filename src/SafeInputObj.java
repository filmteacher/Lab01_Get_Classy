...
/**
 *
 * @author Original Author of SafeInput library: Tom Wulf Tom.Wulf@uc.edu
 */

public class SafeInputObj
{
    // Add a Scanner called pipe as a class variable
    ...
    /**
     * Get a String which contains a minimum length of characters
